...
//give a button to resert the game 
//every colum is only clickable once 
//if all normal cells are clicked and none is left then show alert that won
// if a bomb is clicked then show alert u have lost 
